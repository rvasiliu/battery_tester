...
STATIC_URL = '/static/'#'{sep}static{sep}'.format(sep=os.sep)
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/'
...
CHARGING_SETPOINT = -600
INVERTING_SETPOINT = 600
INVERTER_TIMEOUT_ATTEMPT_NUMBER = 10
INVERTER_OVER_TIME = 60


BATTERY_CELL_OVP_LEVEL_1 = 3.60
BATTERY_CELL_OVP_LEVEL_2 = 3.70
BATTERY_CELL_UVP_LEVEL_1 = 2.9
BATTERY_CELL_UVP_LEVEL_2 = 2.7
BATTERY_OCP = 35
MOSFETS_OVERTEMPERATURE = 80
CELLS_OVERTEMPERATURE = 80
BATTERY_OVER_TIME = 60 # seconds of battery not responding
BATTERY_TIMEOUT_ATTEMPT_NUMBER = 10

LOOKUP_TABLE_FILE_NAME = 'test_recipe.csv'
